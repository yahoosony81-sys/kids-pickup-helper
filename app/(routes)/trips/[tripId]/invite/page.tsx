...
import { AvailablePickupRequestsList } from "@/components/trips/available-pickup-requests-list";
...
export default async function InvitePage({ params }: InvitePageProps) {
  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-4xl">
      ...
      {/* 요청자 리스트 */}
      <AvailablePickupRequestsList
        tripId={trip.id}
        isTripLocked={trip.is_locked}
        initialRequests={availableRequests}
        tripScheduledStartAt={trip.scheduled_start_at}
      />
